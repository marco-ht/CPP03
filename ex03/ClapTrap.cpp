...
/*   Updated: 2025/10/28 05:55:43 by mpierant         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#include "ClapTrap.hpp"
    ...
    ClapTrap::ClapTrap():
    /* ClapTrap::name("no_name_clap_name"), */ hit_points(10), energy_points(10), attack_damage(0)
    {
    ...
    /* ClapTrap::name(other.ClapTrap::name), */ hit_points(other.hit_points),
    ...
    ClapTrap::~ClapTrap()
    {
        std::cout << "ClapTrap (" << ClapTrap::name << "): Destructor called" << std::endl;
    }
    //End Canonical Orthodox Class
    
    ClapTrap::ClapTrap(const std::string& name):
    /* ClapTrap::name(name), */ hit_points(10), energy_points(10), attack_damage(0)
    {
        ClapTrap::name = name;
        std::cout << "Constructor: ClapTrap " << this->ClapTrap::name << " created." << std::endl;
    }
    ...
    void ClapTrap::attack(const std::string& target)
    {
        ...
        {
            std::cout << "ClapTrap " << ClapTrap::name << ": no energy or hit points left "
    ...
    void ClapTrap::takeDamage(unsigned int amount)
    {
        if (hit_points == 0)
        {
            std::cout << "ClapTrap " << ClapTrap::name << " hit points already 0 "
        ...
        if (amount >= static_cast<unsigned int>(hit_points))
            ...
            hit_points -= amount;
        std::cout << "ClapTrap " << ClapTrap::name << " receive "
    ...
    void ClapTrap::beRepaired(unsigned int amount)
    {
        ...
        hit_points += amount;
        energy_points--;
        std::cout << "ClapTrap " << ClapTrap::name << " repairs itself , regaining "
